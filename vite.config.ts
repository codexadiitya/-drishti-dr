...
const siteConfiguration = {
  title: 'NetraRakshaq — AI Diabetic Retinopathy Screening',
  description: 'Explainable AI screening and tele-ophthalmology triage platform for underserved communities.',
  language: 'en',
}
