  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-400 mt-0.5">End-to-end NetraRakshaq VisionNex pipeline — from fundus acquisition to clinical referral and telemedicine capacity optimization</p>
      </div>
      ...
      <div className="p-4 bg-slate-900 border border-slate-800 rounded-xl">
        <p className="text-xs text-slate-500 text-center">
          NetraRakshaq VisionNex Architecture · Prototype v1.0 · Hackathon build · For evaluation purposes only · Not approved for clinical deployment
        </p>
      </div>
    </div>
  );
